...
# Balance is not available via any discoverable public endpoint.
BALANCE_NOTE = (
    "Account balance/credits are not exposed via a public Hyperagent API endpoint; "
    "check your billing page at hyperagent.com. This proxy verifies the session and "
    "shows the account it belongs to."
)
